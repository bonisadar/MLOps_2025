...
def run_register_model(data_path: str, top_n: int):
    ...
    # Retrain and log each top model on new data
    for run in hpo_runs:
        train_and_log_model(data_path=data_path, params=run.data.params)

    # Step 3: After logging, find the best run based on test RMSE
    ...
    mlflow.register_model(model_uri=model_uri, name="nyc-Green-taxi-rf-Best-model")
